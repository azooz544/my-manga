    ...
    <header className="fixed top-0 right-0 left-0 z-50 bg-background border-b border-border">
      <div className="container flex items-center justify-between h-16">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold text-white hidden sm:inline">موقع الأنمي</span>
        </div>

        {/* Desktop Navigation */}
        <nav className="hidden md:flex items-center gap-8">
          <a href="#" className="text-foreground hover:text-accent transition-colors">الرئيسية</a>
          <a href="#" className="text-foreground hover:text-accent transition-colors">الأنمي</a>
          <a href="#" className="text-foreground hover:text-accent transition-colors">الأفلام</a>
      ...
      {isMenuOpen && (
        <nav className="md:hidden bg-secondary border-t border-border">
          <div className="container py-4 flex flex-col gap-3">
            <a href="#" className="text-foreground hover:text-accent transition-colors py-2">الرئيسية</a>
            <a href="#" className="text-foreground hover:text-accent transition-colors py-2">الأنمي</a>
            <a href="#" className="text-foreground hover:text-accent transition-colors py-2">الأفلام</a>
